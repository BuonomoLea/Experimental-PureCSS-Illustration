# Experimental Pure CSS Illustration
...
Base pour l'intégration du système sonore, vous pouvez testez les touches à la souris. (Audio au format wav dont pack de drums provenant de "1000 Gecs & the Tree of Clues Drum Kit")
...
- JavaScript (dynamisme des autres touches et performance à venir)

## Licence

Ce projet est open-source. N’hésitez pas à le cloner, faire une pull request ou le partager !
